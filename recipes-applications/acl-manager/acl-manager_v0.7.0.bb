...
export CONFIG_SAH_SERVICES_ACL-MANAGER_REQUIRES_USERS
...
SAH_CONFIG += " \
                ...
                CONFIG_SAH_SERVICES_ACL-MANAGER_REQUIRES_USERS \
                "
...
FILES:${PN} += "/etc/amx/${COMPONENT}/extensions/${COMPONENT}_requires_users.odl"
