...
FILES:${PN} += "/usr/local/lib/lua/${CONFIG_SAH_LUA_AMX_LUA_VERSION}/lamxb.lua"
FILES:${PN} += "/usr/local/lib/lua/${LUA_DEFAULT_VERSION}/lamxb.lua"
FILES:${PN} += "/usr/lib/lua/lamx.so"
FILES:${PN} += "/usr/lib/lua/lamx.so"
FILES:${PN} += "/usr/lib/lua/lamx_wait_for.lua"
FILES:${PN} += "/usr/lib/lua/lamx_wait_for.lua"
